...
@Component({
  selector: 'app-e-nouvelle-demande-autre',
  templateUrl: './e-nouvelle-demande-autre.component.html',
  styleUrls: ['./e-nouvelle-demande-autre.component.scss']
})
export class ENouvelleDemandeAutreComponent implements OnInit {
  ...
  creerDemande(){
    // control
    if(!this.raison.trim() || !this.commentaire.trim() ||!this.titre.trim()){
